...
const walkGlob = import.meta.glob<string>(
  './animations/walk-1/*/*.png',
  { eager: true, import: 'default' }
)

export const WALK_FRAMES: Record<Direction, string[]> = {} as Record<
  Direction,
  string[]
>
...
const deathGlob = import.meta.glob<string>(
  './animations/falling-back-death/*/*.png',
  { eager: true, import: 'default' }
)

export const DEATH_FRAMES: Record<Direction, string[]> = {} as Record<
  Direction,
  string[]
>
for (const dir of directions) {
